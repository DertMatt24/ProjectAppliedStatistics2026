...
class WindowedPowerAHIGradientBoostingWithFeatureSelection:
    """
    Gradient Boosting regression on AHI with feature selection.

    Workflow:
        clinical/windowed-power features
        -> GradientBoostingRegressor feature selection
        -> GradientBoostingRegressor predicts AHI
        -> predicted AHI is converted into severity class
    ...
    def _load_and_align_data(self):
        ...
        print("completed_samples shape:", completed_samples.shape)
    ...
    def build_model(self):
        selector_regressor = GradientBoostingRegressor(
        ...
        self.model = Pipeline([
            ...
            ("feature_selection", SelectFromModel(
                estimator=selector_regressor,
                threshold=-np.inf,
                max_features=self.max_features_to_select
            )),
    ...
    def cross_validate(self):
        ...
        print("\nGroupKFold Gradient Boosting regression results:")
        ...
        print(
            f"Selected features: "
            f"{np.mean(selected_features_counts):.1f} "
            f"± {np.std(selected_features_counts):.1f}"
        )
        ...
        disp.plot()
        plt.title("Aggregated confusion matrix: GB regression -> severity")
    ...
    def final_fold_regression_plot(self):
        ...
        plt.title("Gradient Boosting Regression: Predicted vs True AHI")
...
def main():
    experiment = WindowedPowerAHIGradientBoostingWithFeatureSelection(
        patients_csv_path=(
