...
class WindowedPowerAHIRegressorWithFeatureSelection:
    """
    Random Forest regression on AHI with feature selection.

    Workflow:
        clinical/windowed-power features
        -> RandomForest feature selection
        -> RandomForestRegressor predicts AHI
    ...
    def build_model(self):
        selector_regressor = RandomForestRegressor(
    ...
    def cross_validate(self):
        ...
        disp.plot()
        plt.title("Aggregated confusion matrix: RF regression -> severity")
    ...
    def final_fold_regression_plot(self):
        ...
        plt.title("Random Forest Regression: Predicted vs True AHI")
...
def main():
    experiment = WindowedPowerAHIRegressorWithFeatureSelection(
        patients_csv_path=(
