...
class MultimodalSeverityRandomForestFeatureSelection:
    """
    Random Forest classifier with embedded feature selection.
    ...
    def final_fold_report(self):
        ...
        print("Total features:", len(selected_mask))
        ...
        disp.plot()
        plt.title(f"Random Forest + Feature Selection - {self.mode}")
...
def main():
    experiment = MultimodalSeverityRandomForestFeatureSelection(
        patients_csv_path=(
